...
add_filter( 'genesis_prev_link_text', 'dn_genesis_prev_link_text_numeric' );
add_filter( 'genesis_next_link_text', 'dn_genesis_next_link_text_numeric' );

function dn_genesis_prev_link_text_numeric( $text ) {
...
function dn_genesis_next_link_text_numeric( $text ) {
    if ( 'numeric' === genesis_get_option( 'posts_nav' ) ) {
