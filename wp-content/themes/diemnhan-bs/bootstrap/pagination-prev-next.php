...
add_action( 'genesis_after_endwhile', 'dn_genesis_posts_nav' );

/**
 * Replacement for genesis_posts_nav() that replaces the call to
 * genesis_prev_next_posts_nav() with
 * dn_genesis_prev_next_posts_nav()
 *
 * @since 0.7.0
 */
function dn_genesis_posts_nav() {
 ...
 * @since 0.7.0
 */
function dn_genesis_prev_next_posts_nav() {
