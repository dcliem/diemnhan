          ...
          if(version_compare(WPB_VC_VERSION,  "4.4")>= 0){
            ...
            "params" => array(
              array(
                ...
                "holder" => "",
                "class" => "vc_flipbox_cq",
                "heading" => __("Image (or icon) style for whole element:", "vc_flipbox_cq"),
              ...
              array(
                "type" => "attach_image",
                "heading" => __("Background image for current card (optional)", "vc_flipbox_cq"),
                "param_name" => "frontfullimage",
                "value" => "",
                // "dependency" => Array('element' => "avatartype", 'value' => array('fullimage')),
                "group" => "Front Card",
              ...
              array(
                ...
                "holder" => "",
                "class" => "vc_flipbox_cq",
                "heading" => __("Display current card with:", "vc_flipbox_cq"),
              ...
              array(
                "type" => "attach_image",
                "heading" => __("Header avatar image (will be displayed in circle)", "vc_flipbox_cq"),
        ...
        function cq_vc_flipbox_func($atts, $content=null, $tag) {
          ...
          if($avatarstyle=="fixed"){
              if($avatartype=="image"){
                ...
                if($avatarimage[0]!="")$output .= '<img src="'.$avatarthumb.'" width="'.$avatarsize.'" height="'.$avatarsize.'" class="cq-flipbox-avatar '.$isshadow.'" />';
          ...
          if($avatarstyle=="both"){
              if($avatartype=="image"){
                if($avatarimage[0]!="")$output .= '<img src="'.$avatarthumb.'" width="'.$avatarsize.'" height="'.$avatarsize.'" class="cq-flipbox-cardavatar '.$isshadow.'" />';
              }elseif ($avatartype=="icon") {
                  if(version_compare(WPB_VC_VERSION,  "4.4")>=0&&isset(${'icon_' . $avataricon})){
          ...
          if($backavatar=="image"){
              ...
              if($backimage[0]!="") $output .= '<img src="'.$backthumb.'" width="'.$avatarsize.'" height="'.$avatarsize.'" class="cq-flipbox-cardavatar '.$isshadow.'" />';
