	...
	class woo_visual_hook_guide {
		...
		public function __construct() {
			...
			if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
				...
				add_action( 'admin_notices', array( $this, 'wvh_woocommerce_missing_notice' ) );
			}
		} // end of contructor
		...
		public function wvhg_woocommerce_missing_notice() {
			echo '<div class="error"><p>' . sprintf( __( 'Woocommerce Visual Hook Guide says "There must be active install of %s to take a flight!"', 'woo-visual-hook-guide' ), '<a href="http://www.woothemes.com/woocommerce/" target="_blank">' . __( 'WooCommerce', 'woo-floating-minicart' ) . '</a>' ) . '</p></div>';
